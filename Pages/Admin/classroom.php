...
<body>
    ...
    <div id="container">
        ...
        <table id = "tables">
            ...
            <?php
                $getClassroom = mysqli_query($con, "SELECT classroom_id, name FROM classroom ORDER BY CASE WHEN classroom_id = '2d2fbcde-7b29-11f0-8f15-00163e98734c' THEN 0 ELSE 1 END, REGEXP_REPLACE(name, '^[^a-zA-Z0-9]+', '') ASC");
